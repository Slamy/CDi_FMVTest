...
int channel;
{
	...
	DEBUG(mv_org(mvPath, mvMapId, 240, 240, 0));
...
int sigCode;
{
	...
	else if ((sigCode & 0xf000) == MV_SIG_BASE)
	{
		...
		static int frames_before_lpd = 0;
		...
		if (sigCode & MV_TRIG_PIC)
		{
			...
			/* Draw something in sync with the MPEG video */

			switch (framecnt % 4)
			{
			case 0:
				draw2x2(paVideo1, 120 - 3, 120 + 32 + 3, 0);
				draw2x2(paVideo1, 120 + 5, 120 + 16 + 8, 0);

				draw2x2(paVideo1, 120 - 5, 120 - 5, 2); /* Top Left Outside */
				draw2x2(paVideo1, 120 + 5, 120 + 5, 2); /* Top Left Inside */

				break;
			case 1:
				draw2x2(paVideo1, 120 - 5, 120 - 5, 0);
				draw2x2(paVideo1, 120 + 5, 120 + 5, 0);

				draw2x2(paVideo1, 120 + 32 + 3, 120 - 5, 2);
				draw2x2(paVideo1, 120 + 16 + 8, 120 + 5, 2);

				break;
			case 2:
				draw2x2(paVideo1, 120 + 32 + 3, 120 - 5, 0);
				draw2x2(paVideo1, 120 + 16 + 8, 120 + 5, 0);

				draw2x2(paVideo1, 120 + 32 + 3, 120 + 32 + 3, 2);
				draw2x2(paVideo1, 120 + 16 + 8, 120 + 16 + 8, 2);

				break;
			case 3:
				draw2x2(paVideo1, 120 + 32 + 3, 120 + 32 + 3, 0);
				draw2x2(paVideo1, 120 + 16 + 8, 120 + 16 + 8, 0);

				draw2x2(paVideo1, 120 - 3, 120 + 32 + 3, 2);
				draw2x2(paVideo1, 120 + 5, 120 + 16 + 8, 2);
