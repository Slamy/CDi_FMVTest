# FMV Moving Windows with internal state analysis
...
The internal state is analyzed and printed on the UART. The motivation for this application is to check for emulation accuracy.
