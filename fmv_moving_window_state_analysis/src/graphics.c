...
void createVideoBuffers() {
    ...
    dc_wrli(videoPath, lctA, 2, 6,
            cp_icm(ICM_CLUT7, ICM_CLUT7, NM_1, EV_ON, CS_A));
...
void copyRect(sourceBuffer, targetBuffer, x, y, width, height,
              sourceWidth) u_char *sourceBuffer,
    *targetBuffer;
