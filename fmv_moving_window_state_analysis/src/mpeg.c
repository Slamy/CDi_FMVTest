...
void initMpeg() {
    ...
    printf("InitMPEG %d %d - %X %X - %X %X\n", maPath, mvPath, &mvPcl[0],
           mvPcl[0].PCL_Nxt, &mvPcl[MV_PCL_COUNT - 1],
           mvPcl[MV_PCL_COUNT - 1].PCL_Nxt);
}
...
static unsigned long regdump[REGDUMP_SIZE][36];
    ...
    if (sigCode == MPEG_SIG_PCB) {
        ...
        if (mpegStatus == MPP_PLAY) {
            ...
            if (startcnt > 0) {
                ...
                record_state(2);
                DEBUG(mv_window(mvPath, mvMapId, x * 2, y * 2, 66 * 2, 44 * 2,
                                0));
                record_state(3);
                startcnt--;
...
void record_state(int softpos) {
    ...
    if (regdump_index >= REGDUMP_SIZE || recording_stopped ||
    ...
    if (fdrvs1_static) {
        ...
        unsigned char V_UpdFlag =
            *(unsigned char *)(((char *)fdrvs1_static) + 0x12e);
        unsigned short V_VCMD =
            *(unsigned short *)(((char *)fdrvs1_static) + 0x16c);
        unsigned short V_Scroll =
            *(unsigned short *)(((char *)fdrvs1_static) + 0x16a);
        unsigned long V_Window =
            *(unsigned long *)(((char *)fdrvs1_static) + 0xe6);
        unsigned long V_DecOff =
            *(unsigned long *)(((char *)fdrvs1_static) + 0xea);
        unsigned long V_ScrOrg =
            *(unsigned long *)(((char *)fdrvs1_static) + 0xee);
        unsigned long V_ScrOff =
            *(unsigned long *)(((char *)fdrvs1_static) + 0xf2);
        ...
        if ((dts != last_dts) || (pics != last_pics) ||
            ...
            (last_softpos != softpos) || (last_V_LastSCR != V_LastSCR) ||
            ...
            regdump[regdump_index][21] = softpos;
            ...
            regdump[regdump_index][26] = V_UpdFlag;
            regdump[regdump_index][27] = V_VCMD;
            regdump[regdump_index][28] = V_Scroll;
            regdump[regdump_index][29] = V_Window;
